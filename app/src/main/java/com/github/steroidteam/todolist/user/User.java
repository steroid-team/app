...
public interface User {
    ...
    void sendEmailVerification(OnCompleteListener<Void> onComplete) throws UserLoginException;

    void setUserPassword(String newPassword, OnCompleteListener<Void> onComplete)
            throws UserLoginException;

    void sendPasswordResetEmail(OnCompleteListener<Void> onComplete) throws UserLoginException;

    void deleteUser(OnCompleteListener<Void> onComplete) throws UserLoginException;
