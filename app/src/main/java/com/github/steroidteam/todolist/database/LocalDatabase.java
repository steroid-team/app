...
public class LocalDatabase {
    ...
    public CompletableFuture<TodoListCollection> getTodoListCollection() {
        CompletableFuture<String[]> listDirFuture = storageService.listDir(Database.TODO_LIST_PATH);
    ...
    public CompletableFuture<TodoList> putTodoList(TodoList list) {
        ...
        String targetPath = Database.TODO_LIST_PATH + list.getId().toString() + ".json";

        // Serialize the task as an UTF-8 encoded JSON object.
        byte[] listSerialized = JSONSerializer.serializeTodoList(list).getBytes(StandardCharsets.UTF_8);
    ...
    public void removeTodoList(UUID todoListID) throws DatabaseException {
        ...
        String targetPath = Database.TODO_LIST_PATH + todoListID.toString() + ".json";
    ...
    public CompletableFuture<Task> putTask(UUID todoListID, Task task) throws DatabaseException {
        ...
        String listPath = Database.TODO_LIST_PATH + todoListID.toString() + ".json";
    ...
    public CompletableFuture<Note> getNote(UUID noteID) {
        ...
        String notePath = Database.NOTES_PATH + noteID.toString() + ".json";
    ...
    public CompletableFuture<List<UUID>> getNotesList() {
        CompletableFuture<String[]> listDir = this.storageService.listDir(Database.NOTES_PATH);
